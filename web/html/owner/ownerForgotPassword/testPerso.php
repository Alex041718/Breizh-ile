...
//        $mail->Body = 'Change you password right <a href="http://localhost:5555/client/clientForgotPassword/reset-password-page.php?token='. $token .'">here</a>';
        $mail->Body = 'Changer votre mot de passe en cliquant <a target="_blank" href="https://crepetech.ventsdouest.dev/owner/ownerForgotPassword/reset-password-page.php?token='. $token .'">juste ici</a>.';
